...
import nulp.mobile.habittracker.fragments.details.HabitDetailsFragmentArgs
...
class EditHabitFragment : Fragment() {
    ...
    private fun updateHabit() : Habit {
        ...
        val newHabit = Habit(habit.id,newTitle, (Random.nextDouble() * 10).roundToInt().toDouble())
